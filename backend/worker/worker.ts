...
function findPreviousRecorderActionStart(
  actions: RecorderActionRecord[],
  startIndex: number,
) {
...
function findNextRecorderActionStart(
  actions: RecorderActionRecord[],
  startIndex: number,
) {
...
function replaceRecorderActions(
...
function normalizeRecorderParameterKey(value: string) {
...
function createRecorderPrecheckIssue(
...
function truncateRecorderPreview(value: string, maxLength = 80) {
...
function invalidateRecorderAnalysis(session: RecorderSession) {
...
async function publishRecorderLiveEvent(
  session: RecorderSession,
...
async function captureRecorderSnapshot(
  ...
  await publishRecorderLiveEvent(session, snapshot, delta).catch(() => undefined);
